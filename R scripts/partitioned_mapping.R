...
Aristonectinae.ap <- getMRCA(treed.ap@phylo, c("Aristonectes_quiriquinensis", "Wunyelfia_maulensis"))
...
p_ap <- 
  ...
  geom_nodepoint(
    aes(subset = (node %in% c(Thalassophonea.ap, Cryptoclidia.ap, Aristonectinae.ap))), 
    shape = 21,                              
    fill = "black",                    
    color = "black",                         
    size = 0.8                             
